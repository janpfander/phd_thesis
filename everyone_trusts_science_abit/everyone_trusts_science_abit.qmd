...
doi: 10.31219/osf.io/qc43v_v2 d
---

## Quasi-universal acceptance of basic science in the US {#sec-universal}
...
Pfänder, J., Kerzreho, L., & Mercier, H. (2025). *Quasi-universal acceptance of basic science in the US.* [https://doi.org/10.31219/osf.io/qc43v_v2](https://doi.org/10.31219/osf.io/qc43v_v2)
...
We selected 10 science/health related conspiracy theories from the Belief in Conspiracy Theory Inventory (BCTI) [@pennycookOverconfidentlyConspiratorialConspiracy2022] (@tbl-conspiracy). Participants were asked: "Below is a list of events for which the official version has been disputed. For each event, we would like you to indicate to what extent you believe the cover-up version of events is true or false. [1-9; labels: 1 - completely false, 5 - unsure, 9 - completely true]".

#### Conspiracy thinking

For all results presented here, we used the four-item conspiracy mentality questionnaire (CMQ) [@bruderMeasuringIndividualDifferences2013]. We also assessed the single item conspiracy beliefs scale (SICBS) [@lantianMeasuringBeliefConspiracy2016]. Details and comparisons between the scales can be found in the ESM.

```{r conspiracy, echo=FALSE}
#| label: tbl-conspiracy
#| tbl-cap: "Conspiracy items."
